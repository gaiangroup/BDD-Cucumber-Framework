...
const { handleGenericForm, waitUntilPageIsReady, handleAssertions, switchToTabOrModule,threeDotActionMenu, clickButton } = require('../utils/commonFunctions');
...
Then('User should click on three dot menu and choose Delete action', { timeout: 20000 }, async function () {
    await waitUntilPageIsReady(this.page);
    await threeDotActionMenu(this.page, project_testData.menuAction_Role);
});
